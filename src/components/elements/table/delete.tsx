...
type IconProps = { className?: string, onDeleteHandler: (value: string) => void; rowId: string };
const DeleteIcon = ({ rowId, className, onDeleteHandler }: IconProps) => {

  return (
    <svg width="800px" height="800px" viewBox="0 0 1024 1024" className={`icon ${className}`} version="1.1" xmlns="http://www.w3.org/2000/svg" onClick={() => onDeleteHandler(rowId)}>
      ...
      <path d="M354.6 430.3v369.6" fill="#FAFCFB" /><path d="M354.6 813.3c-7.4 0-13.4-6-13.4-13.4V430.3c0-7.4 6-13.4 13.4-13.4s13.4 6 13.4 13.4v369.6c-0.1 7.4-6 13.4-13.4 13.4z" fill="#0F0F0F" />
      ...
      <path d="M665.8 430.3v369.6" fill="#FAFCFB" /><path d="M665.8 813.3c-7.4 0-13.4-6-13.4-13.4V430.3c0-7.4 6-13.4 13.4-13.4s13.4 6 13.4 13.4v369.6c0 7.4-6 13.4-13.4 13.4z" fill="#0F0F0F" /></svg>
  );
};
