...
export default function Page() {
  ...
  const { data, error, loading } = usePrayer()
      ...
      <main className="content-wrapper">
        ...
        <div className="bg-white py-4">
          <div className="container pt-11 pt-md-13 pb-11 pb-md-13 text-center">
            {
              data?.data?.map((j, i) => (<div key={i} className="row mt-8">
                <div className="col-lg-8 col-xl-7 col-xxl-6 mx-auto">
                  ...
                  <NextLink href={j.end_time ?? ''} title="Join Online" className="btn btn-soft-primary rounded-pill" />
                </div>
              </div>)
              )
            }
